            ...
            <div className="w-full max-w-md bg-neutral-primary-soft p-6 sm:p-8 border border-default rounded-base shadow-lg select-none">
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                        ...
                        <Link href="#" className="text-sm font-medium text-indigo-600 hover:underline dark:text-indigo-500">
                            فراموشی رمز عبور؟
                        </Link>
                    </div>
                    ...
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300 text-center">
                        ثبت نام نکرده‌ اید؟ <Link href="/signup" className="text-indigo-700 hover:underline dark:text-indigo-500">ایجاد حساب کاربری</Link>
                    </div>
                </form>
            </div>
        </div>
