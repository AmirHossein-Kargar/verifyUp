        ...
        <div className="fixed inset-0 flex items-center justify-center p-4 sm:pt-20 overflow-hidden" dir="rtl">
            <div className="w-full max-w-md bg-neutral-primary-soft p-6 sm:p-8 border border-default rounded-base shadow-lg select-none">
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <button type="submit" className="w-full text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 mb-3 sm:mb-4" disabled={isSubmitting}>
                        {isSubmitting ? "در حال ارسال..." : "ثبت نام"}
                    </button>

                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300 text-center">
                        قبلاً ثبت نام کرده‌ اید؟{" "}
                        <Link href="/login" className="text-indigo-700 hover:underline dark:text-indigo-500">
                            ورود به حساب
                        </Link>
                    </div>
                </form>
