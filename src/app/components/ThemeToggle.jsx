...
export default function ThemeToggle() {
    ...
    useEffect(() => {
        setMounted(true);
        // Check current theme from DOM class instead of localStorage to avoid mismatch
    ...
    return (
        ...
        >
            {isDark ? (
                <svg className="size-4 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
