...
export default function StepCard({ step, title, description, icon, index }) {
  ...
  return (
    <MotionWrapper
      ...
      className="h-full w-full p-4 sm:p-6 bg-white border border-gray-200 rounded-lg shadow hover:shadow-xl dark:bg-gray-800 dark:border-gray-700 transition-shadow cursor-pointer flex flex-col items-center text-center"
    >
      ...
      <div className="flex items-center justify-center mb-2">
        <span className="text-xl sm:text-2xl font-bold text-indigo-600 dark:text-indigo-400 ml-2">{step}</span>
