...
module.exports = defineConfig({
  ...
  projects: [
    ...
    { name: 'chromium', use: { ...devices['Desktop Chrome'] }, testIgnore: /orders\/order-flow\.spec\.js/ },
    { name: 'firefox', use: { ...devices['Desktop Firefox'] }, testIgnore: /orders\/order-flow\.spec\.js/ },
    { name: 'webkit', use: { ...devices['Desktop Safari'] }, testIgnore: /orders\/order-flow\.spec\.js/ },
  ],
  timeout: 30_000,
